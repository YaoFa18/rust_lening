...
impl crate::rcc::SealedRccPeripheral for peripherals::FSMC {
    fn frequency() -> crate::time::Hertz {
        unsafe {
            unwrap ! (crate :: rcc :: get_freqs () . hclk3 . to_hertz () , "peripheral '{}' is configured to use the '{}' clock, which is not running. \
                    Either enable it in 'config.rcc' or change 'config.rcc.mux' to use another clock" , "FSMC" , "hclk3")
        }
    }
    fn bus_frequency() -> crate::time::Hertz {
        unsafe {
...
impl crate::rcc::RccPeripheral for peripherals::FSMC {}
...
pin_trait_impl!(crate::timer::TimerPin<Ch1>, TIM10, PB8, 3u8);
pin_trait_impl!(crate::timer::TimerPin<Ch1>, TIM10, PF6, 3u8);
pin_trait_impl!(crate::timer::TimerPin<Ch1>, TIM11, PB9, 3u8);
pin_trait_impl!(crate::timer::TimerPin<Ch1>, TIM11, PF7, 3u8);
pin_trait_impl!(crate::timer::TimerPin<Ch1>, TIM12, PB14, 9u8);
pin_trait_impl!(crate::timer::TimerPin<Ch2>, TIM12, PB15, 9u8);
pin_trait_impl!(crate::timer::TimerPin<Ch1>, TIM13, PA6, 9u8);
pin_trait_impl!(crate::timer::TimerPin<Ch1>, TIM13, PF8, 9u8);
pin_trait_impl!(crate::timer::TimerPin<Ch1>, TIM14, PA7, 9u8);
pin_trait_impl!(crate::timer::TimerPin<Ch1>, TIM14, PF9, 9u8);
...
pin_trait_impl!(crate::timer::TimerPin<Ch1>, TIM9, PA2, 3u8);
pin_trait_impl!(crate::timer::TimerPin<Ch2>, TIM9, PA3, 3u8);
pin_trait_impl!(crate::timer::TimerPin<Ch1>, TIM9, PE5, 3u8);
pin_trait_impl!(crate::timer::TimerPin<Ch2>, TIM9, PE6, 3u8);
...
pub mod peripheral_interrupts {
    ...
    pub mod FSMC {
        pub type GLOBAL = crate::interrupt::typelevel::FSMC;
    }
    pub mod GPIOA {}
    pub mod GPIOB {}
    pub mod GPIOC {}
